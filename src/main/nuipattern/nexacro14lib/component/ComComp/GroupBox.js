...
if (!nexacro.GroupBox)
{
    ...
    {
        var title_size = this._GetTextSize(this._display_text);  //[100,20];
        var titleButton = this.titleButton;
    ...
    {
        return { left: comp._client_left, top: comp._client_top, right: comp._client_left + comp._client_width, bottom: comp._client_top + comp._client_height, width: comp._client_width, height: comp._client_height };
    };
    ...
    //==================================================================================
    // nexacro.TitleCtrl : Button
    // description :  GroupBox'title subComp
    //==================================================================================
    ...
    //==================================================================================
    // nexacro.MainCtrl : Static
    // description :  GroupBox subComp
    //==================================================================================    
    ...
    //==================================================================================
    // nexacro.TitleBorderCtrl : Static
    // description :  GroupBox' subComp
    //================================================================================== 
    ...
    //==========================================================================================================
    // nexacro.GroupBoxCtrl : GroupBox
    // description :  GroupBox used as Control ==> use Event Notifiers, style control - controlType
    //==========================================================================================================
