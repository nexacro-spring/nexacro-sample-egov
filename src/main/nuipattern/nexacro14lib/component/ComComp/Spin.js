...
if (!nexacro.Spin)
{
    ...
    nexacro.Spin = function (id, position, left, top, width, height, right, bottom, parent)
    {
        ...
        this._event_list = {
            ...
            "onchanged": 1, "onspin": 1, "canchange": 1, "oneditclick": 1,
            "ontextchange": 1, "ontextchanged": 1, "cancharchange": 1, "onchar": 1,
            "oncontextmenu": 1,
    ...
    //===============================================================
    // nexacro.SpinEditCtrl : Style Part
    //===============================================================
    /* find currentStyle */
