...
if (!nexacro.Div)
{
    nexacro.Div = function (id, position, left, top, width, height, right, bottom, parent)
    {
		...
		"canlayoutchange": 1, "canstepchange": 1, "onlayoutchanged": 1, "onstepchanged": 1, "onmouseup": 1, "onmousedown": 1,
            // Touch,TouchGesture
	...
	_pDiv.on_created_contents = function ()
	{
	    ...
	    //  When set_url() before addChild() should handle error.Associated div1-2
