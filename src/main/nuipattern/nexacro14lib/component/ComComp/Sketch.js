...
if (!nexacro.Sketch)
{
    ...
    // ==============================================================================
    // nexacro.SketchSuccessEventInfo
    // ==============================================================================
    ...
    nexacro.Sketch = function (id, position, left, top, width, height, right, bottom, parent)
    {
        ...
        this.undoable = false;
        this.redoable = false;
        this.editmode = "stroke";                  // "text", "erase", default "stroke"
        this.imemode = "none";
        ...
        this._save_image_formattype = ["BMP", "PNG", "JPG", "GIF", "TIF", "BMP,Mono"]; // BMP Format ( default )
        this._image = null;                        // save image object for loadSketch method 
        this._clr_history = true;                  // use clear history for loadsketch method
        this._currentPath = [];
        this._pre_draw_status = "";
        this._butt_count = 0;

        this._const_code_parameter = "0001";       //ObjectError Parameter Error  
        this._const_code_io = "1101";              //ObjectError I/O Error
        this._const_code_permission = "1102";      //ObjectError permission denied
        this._const_code_Irregular = "1103";       //ObjectError Irregular Expression error
        this._const_code_target = "1104";          //ObjectError Removed target 
        this._const_code_loadinvalidimage = "1105";//ObjectError Image Info [", "%0", "] is not found.
        this._const_code_incorrectfile = "1106";   //TypeError   The file is not correct.
        this._const_code_savefile = "1107";        //ObjectError Failed to save file.
        ...
        this._event_list = {
            ...
            "onchar": 1, "ondrag": 1, "ondrop": 1, "ondragenter": 1, "ondragleave": 1,
            "ondragmove": 1
        };
    ...
    _pSketch.touchStatus = 0;                      // 0:move 1:down 2:move 3:up
    ...
    _pSketch.on_create_contents = function ()
    {
        ...
        if (control_elem)
        {
            ...
            this.textedit = new nexacro.SketchEditCtrl("sketchedit", "absolute", this._default_edit_x, this._default_edit_y,
    ...
    _pSketch.saveSketchToFile = function (fileName, fileType, option)
    {
        ...
        if (fileType == this._save_image_formattype[2] && !option) option = 100;
    ...
    _pSketch._isCheckColor = function (color)
    {
        ...
        if (color.substring(1) == "gradation")  return true;
    ...
    _pSketch.showTextEditor = function (x, y, width, height, text)
    {
        ...
        if (text && text !== undefined && text != "") multiline = true;
    ...
    {
        if (this._checkEditmode() == false || this.readonly) return;
    ...
    _pSketch._showTextEditor = function (x, y, width, height, text)
    {
        ...
        if (this._isEnableRedraw())
        {
            ...
            if (text && text !== undefined && text != "")
            {
                if (text.length > 0) this.textedit.setSelect(0, text.length);
            }
        }
        return rettext;
    };
    ...
    _pSketch._drawBcurve = function (path, ctx)
    {
	    ...
	    for (var n = 0; n < length; n++)
	    {
	        ...
	        if (n == 0) this._setupCanvasElem(ctx, p1, p2);
        ...
        */
        ...
        for (var n = 0; n < length; n++)
        {
            var p1 = path[n];
            var p2 = path[n + 1];
            if (n == 0) this._setupCanvasElem(ctx, p1, p1);
    ...
    {
        if (this.textedit.visible == false) return;
