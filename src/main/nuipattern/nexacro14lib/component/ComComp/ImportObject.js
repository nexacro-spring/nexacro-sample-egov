...
if (!nexacro.ExcelImportObject)
{
    ...
    nexacro.ExcelImportObject = function (name, parent)
    {
        ...
        this._importfilemode = 0; // local 0 , server 1
    ...
    _pExcelImport.importData = function (fileurl, range, responseData, userData)
    {
        ...
        //nexacro._append_hidden_item(this.id, "upfile", this._checkUploadFile, this, this._handle);
        ...
        if (responseData)
        {
            ...
            this._responseRVal = [];
            var temp_response = "";
            //var responArr = responseData.replaceAll(" ", "").split("=");
            //var responseDatas = responseData.match(/[A-Za-z0-9]+=[A-Za-z0-9]+/g);
            ...
            if (properties == null)
            {
                ...
                if (range.indexOf("!") > 0)
                {
                    ...
                    if (range_arr[1].indexOf(":") > 0)
                    {
                        ...
                        //var sheet = range_arr[0].replaceAll(" ", "$_$");
