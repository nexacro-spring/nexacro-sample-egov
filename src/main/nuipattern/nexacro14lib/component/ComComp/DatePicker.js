...
if (!nexacro.DatePicker)
{
    ...
    _pDatePickerStyle.__get_custom_style_value = function ()
    {
        ...
        if (this.ncpadding && !this.ncpadding._is_empty) val += "ncpadding:" + this.ncpadding._value + "; ";
        if (this.usetrailingday && !this.usetrailingday._is_empty) val += "usetrailingday:" + this.usetrailingday._value + "; ";
        if (this.headerformat && !this.headerformat._is_empty) val += "headerformat:" + this.headerformat._value + "; ";
        if (this.weekformat && !this.weekformat._is_empty) val += "weekformat:" + this.weekformat._value + "; ";
        if (this.daysize && !this.daysize._is_empty) val += "daysize:" + this.daysize._value + "; ";
        if (this.daycolor && !this.daycolor._is_empty) val += "daycolor:" + this.daycolor._value + "; ";
        if (this.daybackground && !this.daybackground._is_empty) val += "daybackground:" + this.daybackground._value + "; ";
        if (this.daygradation && !this.daygradation._is_empty) val += "daygradation:" + this.daygradation._value + "; ";
        if (this.dayborder && !this.dayborder._is_empty) val += "dayborder:" + this.dayborder._value + "; ";
        if (this.daybordertype && !this.daybordertype._is_empty) val += "daybordertype:" + this.daybordertype._value + "; ";
        if (this.dayfont && !this.dayfont._is_empty) val += "dayfont:" + this.dayfont._value + "; ";
        if (this.headerheight && !this.headerheight._is_empty) val += "headerheight:" + this.headerheight._value + "; ";
        if (this.headercolor && !this.headercolor._is_empty) val += "headercolor:" + this.headercolor._value + "; ";
        if (this.headerbackground && !this.headerbackground._is_empty) val += "headerbackground:" + this.headerbackground._value + "; ";
        if (this.headergradation && !this.headergradation._is_empty) val += "headergradation:" + this.headergradation._value + "; ";
        if (this.headerbordertype && !this.headerbordertype._is_empty) val += "headerbordertype:" + this.headerbordertype._value + "; ";
        if (this.headerborder && !this.headerborder._is_empty) val += "headerborder:" + this.headerborder._value + "; ";
        if (this.headerfont && !this.headerfont._is_empty) val += "headerfont:" + this.headerfont._value + "; ";
        if (this.bodybackground && !this.bodybackground._is_empty) val += "bodybackground:" + this.bodybackground._value + "; ";
        if (this.bodygradation && !this.bodygradation._is_empty) val += "bodygradation:" + this.bodygradation._value + "; ";
        if (this.bodybordertype && !this.bodybordertype._is_empty) val += "bodybordertype:" + this.bodybordertype._value + "; ";
        if (this.bodyborder && !this.bodyborder._is_empty) val += "bodyborder:" + this.bodyborder._value + "; ";
        if (this.weekcolor && !this.weekcolor._is_empty) val += "weekcolor:" + this.weekcolor._value + "; ";
        if (this.weekbackground && !this.weekbackground._is_empty) val += "weekbackground:" + this.weekbackground._value + "; ";
        if (this.weekgradation && !this.weekgradation._is_empty) val += "weekgradation:" + this.weekgradation._value + "; ";
        if (this.weekfont && !this.weekfont._is_empty) val += "weekfont:" + this.weekfont._value + "; ";
        if (this.saturdaycolor && !this.saturdaycolor._is_empty) val += "saturdaycolor:" + this.saturdaycolor._value + "; ";
        if (this.sundaycolor && !this.sundaycolor._is_empty) val += "sundaycolor:" + this.sundaycolor._value + "; ";
        if (this.todaycolor && !this.todaycolor._is_empty) val += "todaycolor:" + this.todaycolor._value + "; ";
        if (this.trailingdaycolor && !this.trailingdaycolor._is_empty) val += "trailingdaycolor:" + this.trailingdaycolor._value + "; ";
        if (this.viewyearspin && !this.viewyearspin._is_empty) val += "viewyearspin:" + this.viewyearspin._value + "; ";
        if (this.viewmonthspin && !this.viewmonthspin._is_empty) val += "viewmonthspin:" + this.viewmonthspin._value + "; ";
        if (this.todaybackground && !this.todaybackground._is_empty) val += "todaybackground:" + this.todaybackground._value + "; ";
        if (this.todaygradation && !this.todaygradation._is_empty) val += "todaygradation:" + this.todaygradation._value + "; ";
        if (this.todayborder && !this.todayborder._is_empty) val += "todayborder:" + this.todayborder._value + "; ";
        if (this.todaybordertype && !this.todaybordertype._is_empty) val += "todaybordertype:" + this.todaybordertype._value + "; ";
        if (this.todayfont && !this.todayfont._is_empty) val += "todayfont:" + this.todayfont._value + "; ";
        if (this.saturdaybackground && !this.saturdaybackground._is_empty) val += "saturdaybackground:" + this.saturdaybackground._value + "; ";
        if (this.saturdaygradation && !this.saturdaygradation._is_empty) val += "saturdaygradation:" + this.saturdaygradation._value + "; ";
        if (this.saturdayborder && !this.saturdayborder._is_empty) val += "saturdayborder:" + this.saturdayborder._value + "; ";
        if (this.saturdaybordertype && !this.saturdaybordertype._is_empty) val += "saturdaybordertype:" + this.saturdaybordertype._value + "; ";
        if (this.saturdayfont && !this.saturdayfont._is_empty) val += "saturdayfont:" + this.saturdayfont._value + "; ";
        if (this.sundaybackground && !this.sundaybackground._is_empty) val += "sundaybackground:" + this.sundaybackground._value + "; ";
        if (this.sundaygradation && !this.sundaygradation._is_empty) val += "sundaygradation:" + this.sundaygradation._value + "; ";
        if (this.sundayborder && !this.sundayborder._is_empty) val += "sundayborder:" + this.sundayborder._value + "; ";
        if (this.sundaybordertype && !this.sundaybordertype._is_empty) val += "sundaybordertype:" + this.sundaybordertype._value + "; ";
        if (this.sundayfont && !this.sundayfont._is_empty) val += "sundayfont:" + this.sundayfont._value + "; ";
        if (this.trailingdaybackground && !this.trailingdaybackground._is_empty) val += "trailingdaybackground:" + this.trailingdaybackground._value + "; ";
        if (this.trailingdaygradation && !this.trailingdaygradation._is_empty) val += "trailingdaygradation:" + this.trailingdaygradation._value + "; ";
        if (this.trailingdayborder && !this.trailingdayborder._is_empty) val += "trailingdayborder:" + this.trailingdayborder._value + "; ";
        if (this.trailingdaybordertype && !this.trailingdaybordertype._is_empty) val += "trailingdaybordertype:" + this.trailingdaybordertype._value + "; ";
        if (this.trailingdayfont && !this.trailingdayfont._is_empty) val += "trailingdayfont:" + this.trailingdayfont._value + "; ";
        if (this.accessibility && this.accessibility._is_empty) val += "accessibility:" + this.accessibility._value + "; ";
    ...
    nexacro.DatePicker = function (id, position, left, top, width, height, right, bottom, parent, delay_create)
    {
        ...
        this._has_accessibility_value = false; //popupcalendar open시 두번 읽는 문제
    ...
    //===============================================================
    // nexacro.DatePicker : Create & Destroy & Update
    //===============================================================
    ...
    _pDatePicker.on_apply_prop_enable = function (v)
    {
        ...
        if (control_elem)
        {
            var header = this._header;
            var body = this._body;
            if (header) header._setEnable(v);
            if (body) body._setEnable(v);
        }
    };

    //===============================================================
    // nexacro.DatePicker : Properties
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePicker : Event Handlers
    //===============================================================
    ...
    _pDatePicker.on_notify_datepicker_onlbuttondown = function (obj, e)
    {
        ...
        if (e.fromreferenceobject && (
            e.fromreferenceobject instanceof nexacro.DatePickerBody ||
    ...
    //===============================================================
    // nexacro.DatePicker : Logical Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerHeader : Component
    //===============================================================
    nexacro.DatePickerHeader = function (id, position, left, top, width, height, right, bottom, parent)
    {
        ...
        this._event_list = {
            "onprevclick": 1, "onnextclick": 1, "onyearspin": 1, "onmonthspin": 1
        };
    };
    ...
    //===============================================================
    // nexacro.DatePickerHeader : Style Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerHeader : Create & Destroy & Update
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerHeader : Override
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerHeader : Properties
    //===============================================================
    ...
    {
        if (typeof v == 'object') v = (v.value !== undefined) ? nexacro._toBoolean(v.value) : true;
        else v = nexacro._toBoolean(v);
    ...
    //===============================================================
    // nexacro.DatePickerHeader : Event Handlers
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerHeader : Logical Part
    //===============================================================
    ...
    _pDatePickerHeader._resizeHeader = function ()
    {
        ...
        if (control_elem)
        {
            ...
            if (prevButton) prevButton.move(prevBtn_l, prevBtn_t, prevBtn_w, prevBtn_h, null, null);
            if (nextButton) nextButton.move(nextBtn_l, nextBtn_t, nextBtn_w, nextBtn_h, null, null);

            var rtl = this._rtldirection;
            this._rtldirection = "ltr";
            if (yearStatic) yearStatic.move(yearStatic_l, yearStatic_t, yearStatic_w, yearStatic_h, null, null);
            if (monthStatic) monthStatic.move(monthStatic_l, monthStatic_t, monthStatic_w, monthStatic_h, null, null);

            if (yearSpin) yearSpin.move(yearSpin_l, yearSpin_t, yearSpin_w, yearSpin_h, null, null);
            if (monthSpin) monthSpin.move(monthSpin_l, monthSpin_t, monthSpin_w, monthSpin_h, null, null);
    ...
    //===============================================================
    // nexacro.NextButtonCtrl : Logical Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.HeaderStaticCtrl : Static
    //===============================================================
    ...
    //===============================================================
    // nexacro.HeaderStaticCtrl : Style Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.HeaderSpinCtrl : Style Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerBody : Style Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerBody : Create & Destroy & Update
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerBody : Override
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerBody : Properties
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerBody : Event Handlers
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerBody : Logical Part
    //===============================================================
    ...
    _pDatePickerBody._refreshDay = function ()
    {
        ...
        if (control_elem)
        {
            ...
            if (year < 100) firstDay.setFullYear(year);
    ...
    {
        return { text: text, trailingday: trailingday, visible: visible, currYear: currYear, currMonth: currMonth };
    };
    ...
    //===============================================================
    // nexacro.DayStaticCtrl : Style Part
    //===============================================================
    /* find currentStyle */
    ...
    //===============================================================
    // nexacro.DayStaticCtrl : Logical Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.WeekStaticCtrl : Style Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.WeekStaticCtrl : Logical Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.DatePickerCtrl : DatePicker
    //===============================================================
