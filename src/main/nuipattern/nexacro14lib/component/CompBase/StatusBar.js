...
if (!nexacro.StatusBar)
{
    ...
    {
        var val = "";
        if (this.gripimage && !this.gripimage._is_empty) val += "gripimage:" + this.gripimage._value + "; ";
        if (this.progressbarheight && !this.progressbarheight._is_empty) val += "progressbarheight:" + this.progressbarheight._value + "; ";
        if (this.progressbarwidth && !this.progressbarwidth._is_empty) val += "progressbarwidth:" + this.progressbarwidth._value + "; ";
        if (this.progressbargab && !this.progressbargab._is_empty) val += "progressbargab:" + this.progressbargab._value + "; ";
        if (this.progressbargap && !this.progressbargap._is_empty) val += "progressbargap:" + this.progressbargap._value + "; ";
        if (this.zoomcomboheight && !this.zoomcomboheight._is_empty) val += "zoomcomboheight:" + this.zoomcomboheight._value + "; ";
        if (this.zoomcombowidth && !this.zoomcombowidth._is_empty) val += "zoomcombowidth:" + this.zoomcombowidth._value + "; ";
        if (this.zoomcombogab && !this.zoomcombogab._is_empty) val += "zoomcombogab:" + this.zoomcombogab._value + "; ";
        if (this.zoomcombogap && !this.zoomcombogap._is_empty) val += "zoomcombogap:" + this.zoomcombogap._value + "; ";
        return val;
    };
    ...
    nexacro.StatusBar = function(id, position, left, top, width, height, right, bottom, parent) 
    {
        ...
        this.zoomcombo = null;
        this.showzoomcombo = false; // true -> false 당분간  zoomcombo hide 할것, render에서 확대축소기능될때까지. by comnik
        /* internal value */
    ...
    //===============================================================
    // nexacro.StatusBar : Create & Destroy & Update
    //===============================================================
    _pStatusBar.on_create_contents = function() 
    {
        ...
        if (control_elem) 
        {
            ...
            // TODO ControlElement 상속받은 Element로 교체? (ImageElem은 cursor, hittest_type API없음)
    ...
    //===============================================================
    // nexacro.StatusBar Property Part
    //===============================================================
    ...
    _pStatusBar.set_gripimage = function(v)
    {
		...
		{
			if (!v) this.currentstyle.gripimage._value = v;
    ...
    //===============================================================
    // nexacro.StatusBar : Logical Part
    //===============================================================
    ...
    _pStatusBar._setResizable = function (resizable)
    {
        ...
        if (ownerframe && this._gripimage_elem)
        {
            ...
            // cursor & nc hittest
            //this._gripimage_elem.setElementCursor(cursor);
            //this._gripimage_elem.setElementHittestType(hittest_type);
    ...
    _pStatusBar._updateControlPosition = function (width, height)
    {
        ...
        // TODO text elem size를 progressbar의 left로 제한해야 함.
    };
