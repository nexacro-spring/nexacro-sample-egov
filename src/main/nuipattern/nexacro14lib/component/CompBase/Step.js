...
//        this._oldstepindex = null;
    ...
    _pStep.on_apply_custom_pseudo = function (pseudo)
    {
        ...
        if (align != currentstyle.align) currentstyle.align = align;
        if (color != currentstyle.color) currentstyle.color = color;
        if (font != currentstyle.font) currentstyle.font = font;
        if (padding != currentstyle.padding) currentstyle.padding = padding;

        if (buttonalign != currentstyle.buttonalign) currentstyle.buttonalign = buttonalign;
        if (buttonbackground != currentstyle.buttonbackground) currentstyle.buttonbackground = buttonbackground;
        if (buttonborder != currentstyle.buttonborder) currentstyle.buttonborder = buttonborder;
        if (buttonbordertype != currentstyle.buttonbordertype) currentstyle.buttonbordertype = buttonbordertype;
        if (buttongradation != currentstyle.buttongradation) currentstyle.buttongradation = buttongradation;
        if (buttonimage != currentstyle.buttonimage) currentstyle.buttonimage = buttonimage;
        if (buttonpadding != currentstyle.buttonpadding) currentstyle.buttonpadding = buttonpadding;
        if (buttonsize != currentstyle.buttonsize) currentstyle.buttonsize = buttonsize;
    ...
    //=====================================================================
    // nexacro.Step : Create & Destroy & Update  
    //=====================================================================
    ...
    _pStep.set_stepindex = function (v)
    {
        ...
        this._ischange = false;  //아래에서 변경되지 않는 경우에 대한 처리를 위해 초기화
        if (v != this.stepindex)
        {
    ...
    // ====================================================================
    // nexacro.StepCtrl : Create & Destroy & Update 
    // ====================================================================
