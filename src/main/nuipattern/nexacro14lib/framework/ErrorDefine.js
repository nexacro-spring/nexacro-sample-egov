...
if (this.nexacro)
{
    nexacro._errortable =
    {
        "ko":
        {
            ...
            "object_push_fail_command_auth": ["Command Auth Error. 현재 선택된 IP에 대해 Command socket 인증에 오류가 발생하였습니다."],
            ...
            "object_push_fail_command": ["X-PUSH 서버로 topic 등록/등록해제(command) 요청을 실패했습니다."],
            ...
            "object_push_fail_rgst_unrg": ["X-PUSH 서버로 모바일 DeviceToken 정보 등록/등록해제(command) 요청을 실패했습니다."],
            "object_push_fail_adui_unui": ["X-PUSH 서버로 유저 topic 정보 등록/등록해제(command) 요청을 실패했습니다."],
