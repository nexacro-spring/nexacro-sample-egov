(function()
{
    return function()  {
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            this.frame = frame0;
            frame0.set_separatesize("80,0,*");

            
            var frame1 = new ChildFrame("TopFrame", "absolute", null, null, null, null, null, null, "frame::topFrame.xfdl", frame0);
            frame0.addChild(frame1.name, frame1);
            frame1.set_formurl("frame::topFrame.xfdl");
            frame1.set_dragmovetype("none");
            frame1.set_showtitlebar("false");
            frame1.style.set_background("darkgray");
            frame1.style.set_border("1 solid #808080ff");

            var frame2 = new ChildFrame("LoginFrame", "absolute", null, null, null, null, null, null, "frame::login.xfdl", frame0);
            frame0.addChild(frame2.name, frame2);
            frame2.set_showtitlebar("false");
            frame2.set_showtitleicon("true");
            frame2.set_dragmovetype("none");
            frame2.set_formurl("frame::login.xfdl");
            var frame3 = new HFrameSet("HFrameSet", "absolute", null, null, null, null, null, null, frame0);
            frame0.addChild(frame3.name, frame3);
            frame3.set_separatesize("195,*");

            
            var frame4 = new ChildFrame("LeftFrame", "absolute", null, null, null, null, null, null, "frame::leftFrame.xfdl", frame3);
            frame3.addChild(frame4.name, frame4);
            frame4.set_formurl("frame::leftFrame.xfdl");
            frame4.set_dragmovetype("none");
            frame4.set_showtitlebar("false");
            frame4.style.set_overlaycolor("white");
            frame4.style.set_background("darkgray");
            frame4.style.set_border("1 solid #808080ff");
            frame4.style.set_color("white");
            frame4.style.set_bordertype("normal 0 0");
            frame4.set_showcascadetitletext("true");
            var frame5 = new VFrameSet("VFrameSet1", "absolute", null, null, null, null, null, null, frame3);
            frame3.addChild(frame5.name, frame5);
            frame5.set_separatesize("30,*");

            
            var frame6 = new ChildFrame("MdiTabFrame", "absolute", null, null, null, null, null, null, "frame::tabFrame.xfdl", frame5);
            ...
            var frame7 = new FrameSet("WorkFrame", "absolute", null, null, null, null, null, null, frame5);
            frame5.addChild(frame7.name, frame7);
            frame7.style.set_background("antiquewhite");

            
            var frame8 = new ChildFrame("MainFrame", "absolute", null, null, null, null, null, null, "", frame7);
            frame7.addChild(frame8.name, frame8);
            frame8.set_dragmovetype("none");
            frame8.set_resizable("false");
        ...
        this.loadIncludeScript("mdi_pattern.xadl");
    };
}
)();
