    ...
    if (!nexacro.Element)
    {
	    ...
	    _pTextBoxElement.setElementText = function (text)
	    {
		    if (this.text != text)
		    {
		        ...
		        {
		            //wordwrap != none일때, textcontent를 사용하는 Browser에서 개행문자 표시문제 
	    ...
	    _pImageElement.setElementImageUrl = function (url)
	    {
		    if (this.imageurl != url)
		    {
		        ...
		        if (url) 
		        {
		            var size = nexacro._getImageSize(url, this._on_loadImg, this);
	    ...
	    // in Runtime --> same as nexacro.ImageAlign
	    // nexacro.ImageAlign must has Align Property
	    //======================================================================
        ...
        //value == "" 인경우에는 displaynulltext가 적용되지 않음
	    ...
	    _pInputElement._setCutAction = nexacro._emptyFn; //Cut - Null Function
        ...
        _pControlElementBase.setElementBackground = function (background, gradation)
	    {
		    ...
		    if (background && background.image)
		    {
		        ...
		        if (this._img_url != bkimgurl)
		        {
		            ...
		            var imgsize = nexacro._getImageSize(bkimgurl, this._on_notify_imgsize, this);
	    ...
	    _pControlElementBase.setElementAccessibilityStatAutoComplete = function (autocomplete)
	    {
	        ...
	        //    var _handle = this._handle;
	        //    if (_handle)
	        //        nexacro.__setElementHandleAccessibilityStatAutoComplete(_handle, autocomplete);
	        //}
	    };
	    ...
	    _pControlElementBase._refreshForeground = function (_handle)
	    {
		    ...
		    if (nexacro._enableaccessibility)
		    {
		        ...
		        //    nexacro.__setElementHandleAccessibilityValue(_handle, this._accessibility_value);
		        ...
		        //    nexacro.__setElementHandleAccessibilityStatAutoComplete(_handle, this._accessibility_stat_autocomplete);
	    ...
	    _pControlElementBase._setControlBorder = function (_handle, border, bordertype)
	    {
		    if (_handle)
		    {
		        if (bordertype)
		        {
		            ...
		            nexacro.__setElementHandleBordertype(_handle, bordertype.type, radiusx, radiusy,
							        bordertype._lefttop, bordertype._righttop, bordertype._leftbottom, bordertype._rightbottom);
		        }
		        else
		        {
            ...
            if (border && !border._is_real_empty()) 
		    {
		        if (_handle)
		        {   
			        // apply border to Elemenet Handle
	    ...
	    _pControlElementBase._setControlBackground = function (_handle, background, gradation)
	    {
	        if (background)
	        {
		        if (background.color == "@gradation" && gradation)
		        {
			        ...
			        nexacro.__setElementHandleBackgroundGradation(_handle, gradation.style,
													        gradation._start_x, gradation._start_y, gradation._start_syscolor,
													        gradation._end_x, gradation._end_y, gradation._end_syscolor, gradation._sysvalue);
		        }
		        else
		        {
        ...
        _pSimpleControlElement.destroy = function ()
        {
            ...
            this.parent = null;
            this._parent_elem = null;
    	    // do not destroy client element -- component destroy it
        ...
        //==== internal handles =========//
	    _pFrameControlElement._win_handle = null;  // Window Handle
	    //==== default flags =========//
	    //==== end of initial =========//
	    ...
	    _pFrameControlElement.bringToFrontElement = function (cur_elem)
	    {
	        ...
	        // cur_elem._owner_elem = frameset's client_elem
        ...
        _pFrameControlElement.setElementSize = function (w, h)
        {
            ...
            if (this._is_window_element)
            {
                ...
                // Render Engine은 Async로 작업을 처리하기때문에 
                // Element의 크기가 갱신되기 전이므로 Window 크기를 같이 알려줌.
                nexacro.__updateWindowHandleRegion(
                    win_handle, 
                    border ? border._getBorderLeftWidth() : 0,
                    border ? border._getBorderTopWidth() : 0,
                    border ? border._getBorderRightWidth() : 0,
                    border ? border._getBorderBottomWidth() : 0,
                    bordertype ? bordertype.type : "normal",
                    bordertype ? bordertype.radiusx : 0,
                    bordertype ? bordertype.radiusy : 0, 
                    bordertype ? bordertype.lefttop : true,
                    bordertype ? bordertype.righttop : true,
                    bordertype ? bordertype.leftbottom : true,
                    bordertype ? bordertype.rightbottom : true,
                    w, h);
            }
        };
        ...
        //==== internal handles =========//
        _pFrameResizeBorderElement._win_handle = null;  // Window Handle
        ...
        _pFrameResizeBorderElement.create = function ()
        {
            ...
            if (this._parent_elem == null)
            {
                ...
                this.left = 0;
                this.top = 0;
                this.width = 0;//_win.clientWidth;
                this.height = 0;//_win.clientHeight;
            }
            else
            {
                    ...
                    client_element.width != zclient_width || client_element.height != zclient_height)
			    {
				    ...
				    if (step_count > 0 && step_containers)
				    {
				        for (var i = 0; i < step_count; i++)
				        {
				            ...
				            //step_client_element.setElementSize(zclient_width, zclient_height);
			    ...
			    if (vscroll_control)
			    {
				    ...
				    else
				    {
					    if (this._vscroll_left != (client_left + client_width) || this._vscroll_top != client_top || this._vscroll_height != client_height || reset_vlimit)
					    {
						    ...
						    //vscroll_control._setScrollInfo(this._vscroll_left, client_top, vscroll_width, this._vscroll_height, 0, this.vscroll_limit, 30, client_height, client_height, false, this.scroll_top);
					    }
					    else if (reset_vscroll)
					    {
						    vscroll_control._setScrollPos(this.scroll_top);
			    ...
			    if (hscroll_control)
			    {
				    ...
				    {				
					    if (this._hscroll_left != client_left || this._hscroll_top != (client_top + client_height) || this._hscroll_width != client_width || reset_hlimit)
					    {
						    ...
						    //hscroll_control._setScrollInfo(client_left, this._hscroll_top, this._hscroll_width, this._hscroll_height, 0, this.hscroll_limit, 30, client_width, client_width, false, this.scroll_left);
					    }
					    else if (reset_hscroll)
					    {
						    hscroll_control._setScrollPos(this.scroll_left);
        ...
        //==== internal handles =========//
        _pPopupControlElement._win_handle = null;  // Window Handle
        ...
        //==== internal handles =========//
        _pPopupScrollableControlElement._win_handle = null;  // Window Handle
	    ...
	    _pTextElement.create = function ()
	    {
		    ...
		    if (_owner_elem && _owner_elem._handle && !this._handle)
		    {
			    ...
			    var size = nexacro._getTextSize(this.text, this.font, this._use_newline);
        ...
        // TextElement 와 TextBoxElement(_pElement.setElementSize() 호출됨) 와 다른 처리가 되고있어 주석 처리
        /*
        ...
        */
        ...
        _pPluginElement.pluginname = "";        //for only android mobile
        ...
        _pWebBrowserPluginElement.pluginname = "WebBrowser"; //android에서 사용. 
        ...
        _pGoogleMapPluginElement.pluginname = "GoogleMap"; //android에서 사용. 
	   ...
	   //end
        ...
        _pCanvasElement.setElementFillStyle = function (fillstyle)
        {
            ...
            if (_handle && fillstyle)
            {
                ...
                if (fillstyle instanceof nexacro.Style_color)
                    ...
                    nexacro.__setCanvasFillGradation(_handle, fillstyle.style, fillstyle._start_x, fillstyle._start_y, nexacro._getWebColorFromXreColor(fillstyle.start_color),
													        fillstyle._end_x, fillstyle._end_y, nexacro._getWebColorFromXreColor(fillstyle.end_color), fillstyle._sysvalue);
            }
        };
        ...
        _pGridScrollableControlElement._setInnerElementScrollMaxSize = nexacro._emptyFn; // HTML only        
...
//                  this._client_element.padding = (padding) ? padding : null; 런타임에서 사용 안함.
                }
            ...
            {
//                if (this._mode == "text") 런타임에서 사용 안함.
//                    this._client_element.padding = (padding) ? padding : null;
    ...
    {        
        ...
        {            
            ...
            for (var i = 0; i < len; i++)
            {
                ...
                if (comp)   // 왜 없는 경우가 있는지? 일단 null처리해도 동작상 문제없어 보임.
    ...
    _pEventPassOverlayElement.updateCellNodeClient = function (left, top, width, height, cell_hpos, is_fake_merge)
    {
        ...
        if (_handle)
        {
            if (is_fake_merge)
            {                
                if (cell_hpos >= this._start_hscroll && cell_hpos > 0)
    {
    ...
    /* postion 조정 방식으로 padding 설정이 필요없음 */
