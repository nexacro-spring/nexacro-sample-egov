...
if (!nexacro.ProgressBar)
{
    ...
    nexacro.ProgressBar = function (id, position, left, top, width, height, right, bottom, parent)
    {
        ...
        this.pos = 0;  // default value 0 <- spac why set "0"
        this.step = 1;
        this.max = 100;
        this.min = 0;
        this.blocksize = 15;
    ...
    {        
        var cell_item = this.cellitem;
        if (!cell_item || !bargradation) return;
    ...
    {
        /*
        this.on_apply_style_startimage(this.currentstyle.startimage);
        this.on_apply_style_endimage(this.currentstyle.endimage);
        this.on_apply_style_progressimage(this.currentstyle.progressimage);
        this.on_apply_style_direction(this.currentstyle.direction);
        this.on_apply_style_align(this.currentstyle.align);
        this.on_apply_style_smooth(this.currentstyle.smooth);
        this.on_apply_style_bartype(this.currentstyle.bartype);
    ...
    _pProgressBar._clear = function ()
    {
        ...
        */
        ...
        //if (this.celllist)
            //this.celllist = []; // clear할때 null하면 export시 statusbar에서 error 발생
    ...
    {
        nexacro.Component.prototype.resize.call(this, w, h);   // CompBase call
        this._update();
    };

    _pProgressBar.move = function (left, top, width, height, right, bottom)
    {
        nexacro.Component.prototype.move.call(this, left, top, width, height, right, bottom);   // CompBase call
        this._update();
    };
    ...
    _pProgressBar._update_cell = function ()
    {
        ...
        if (this.progress_img_list)
        {
            ...
            //this.progress_img_list.splice(0, imgLen);
        ...
        if (smooth == "true")
        {
            ...
            {
                l = 0; //cellitem._adjust_left ;  // forward일 경우 left, top은 무조건 0
                t = 0; //cellitem._adjust_top ;
                w = parseInt(width * per) | 0;
                h = height;
            }
    ...
    _pProgressBar._create_img = function (img, img_val, id)
    {
        if (img_val != null && img_val != "")
        {
            ...
            img.style.set_background("URL('" + img_val + "') stretch");     // img_val이 fullpath로 넘어가면 안됨.
    ...
    //==================================================================================
    // ProgressBarCell : Static
    // description :  ProgressBar' bar subComp
    //==================================================================================
    ...
    //_pProgressBarCell.on_apply_text = nexacro._emptyFn;
    ...
    //==================================================================================
    // ProgressBarImg : - Static
    // description :  ProgressBar' ImgBar subComp
    //==================================================================================
    ...
    //------ Static에서 쓰이는 prep 중 불필요한 기능 제거----------//
    ...
    //_pProgressBarImg.on_apply_text = nexacro._emptyFn;
    ...
    //==========================================================================================================
    // ProgressBarCtrl : SubControl
    // description :  ProgressBar used as Control ==> use Event Notifiers, style control - controlType
    //==========================================================================================================
