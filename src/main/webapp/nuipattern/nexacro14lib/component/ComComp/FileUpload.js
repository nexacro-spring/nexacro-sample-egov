...
if (!nexacro.FileUpload)
{
    ...
    {
        var val = "";
        if (this.itemheight && this.itemheight._is_empty) val += "itemheight" + this.itemheight._value + "; ";
        ...
        if (this.editbackground && this.editbackground._is_empty) val += "editbackground" + this.editbackground._value + "; ";
        if (this.editborder && this.editborder._is_empty) val += "editborder" + this.editborder._value + "; ";
        if (this.editbordertype && this.editbordertype._is_empty) val += "editbordertype" + this.editbordertype._value + "; ";
        if (this.editgradation && this.editgradation._is_empty) val += "editgradation" + this.editgradation._value + "; ";
        if (this.editpadding && this.editpadding._is_empty) val += "editpadding" + this.editpadding._value + "; ";
        if (this.editmargin && this.editmargin._is_empty) val += "editmargin" + this.editmargin._value + "; ";
        if (this.editfont && this.editfont._is_empty) val += "editfont" + this.editfont._value + "; ";
        if (this.editcolor && this.editcolor._is_empty) val += "editcolor" + this.editcolor._value + "; ";        
        if (this.editaccessibility && this.editaccessibility._is_empty) val += "editaccessibility" + this.editaccessibility._value + "; ";
        if (this.buttonaccessibility && this.buttonaccessibility._is_empty) val += "buttonaccessibility" + this.buttonaccessibility._value + "; ";
    ...
    nexacro.FileUpload = function (id, position, left, top, width, height, right, bottom, parent)
    {
        ...
        this._want_tab = true; // tab key
        this._want_arrow = false; // arrow key for accessibility
