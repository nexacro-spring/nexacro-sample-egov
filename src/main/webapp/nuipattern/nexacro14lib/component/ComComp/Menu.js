...
if (!nexacro.MenuItem)
{
    ...
    _pMenuItem._updateControl = function (control_elem, pseudo)
    {
        ...
        if (application._cur_track_info && pseudo == "mouseover") return;
    ...
    _pMenuItem._on_dragleave = function (elem, to_comp, src_comp, src_refer_comp, dragdata, userdata,
...
if (!nexacro.Menu)
{
    ...
    nexacro.Menu = function (id, position, left, top, width, height, right, bottom, parent)
    {
        ...
        this._items = [];
        //this._hasMultiPopup = true; // not use
        this._want_tab = true;
    ...
    _pMenu.on_fire_user_onkeydown = function (keycode, alt_key, ctrl_key, shift_key, fire_comp, refer_comp)
    {
        ...
        switch (keycode)
        {
            case E.KEY_TAB:
                ...
                menuitem[this._previousitem].on_apply_mouseover(false);
                if (!popupvisible)
                {
    ...
    {
        var popupmenu = this._popupmenu;
        this._items[this._previousitem].on_apply_mouseover(false);
    ...
    _pMenu._calcMenuItem = function ()
    {
        ...
        if (_buttonRect[0])
        {
            ...
            {
                if (this._scrollIndex == 0) left = this._spin_width;                
            }                        
        }
        ...
        {            
            ...
            {                
                ...
                var rect = { left: 0, top: 0, right: 0, bottom: 0, width: 0};
                rect.left = left;
                rect.top = 0;
    ...
    {        
        ...
        // total item width > client_width
        if (len > 0 && _buttonRect[len - 1].right > this._client_width)
        {
            ...
            if (ds && this.captioncolumn && this.captioncolumn && this.idcolumn)
            {
                ...
                for (var i = 0; i < len; i++)
                {
                    ...
                    if (level == 0)
                    {
                        ...
                        //var item = new nexacro.MenuItem("item", "absolute", left, 0, width, this._client_height, null, null, this);
    ...
    //===============================================================
    // nexacro.SpinButtonCtrl : Style Part
    //===============================================================
