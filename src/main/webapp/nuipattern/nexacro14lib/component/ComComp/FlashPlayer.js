...
if (!nexacro.FlashPlayer)
{
    ...
    /*
    _pFlash.back = function ()
    {
        
    };

    _pFlash.forward = function ()
    {
        
    };

    _pFlash.pan = function ()
    {
    ...
    _pFlash.rewind = function ()
    {
        
    };

    _pFlash.saveTolmage = function ()
    {
        
    };

    _pFlash.saveTolmageObject = function ()
    {
        
    };
    _pFlash.setzoomrect = function ()
    {
