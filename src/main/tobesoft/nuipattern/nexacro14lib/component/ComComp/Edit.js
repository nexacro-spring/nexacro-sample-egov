...
if (!nexacro.Edit)
{
    ...
    nexacro.Edit = function (id, position, left, top, width, height, right, bottom, parent)
    {
        ...
        this._event_list = {
            ...
            "ontouchstart": 1, "ontouchmove": 1, "ontouchend": 1,"ontap": 1, "onlongpress": 1
        };
        ...
        this._caret_pos = { begin: -1, end: -1, org_begin: -1, org_end: -1 };
