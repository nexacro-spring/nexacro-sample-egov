...
if (!nexacro.Static)
{
    ...
    _pStatic.on_apply_text = function ()
    {
        ...
        if (control_elem)
        {
            ...
            // IE8이하 버전은 usedecorate=true일때 값이 있는 경우에는 개행처리가 되지 않습니다.(\r\n)
    ...
    //===============================================================
    // nexacro.Static : Event Overrid
    //===============================================================
    /*
    _pStatic.on_click_basic_action = function (elem, button, alt_key, ctrl_key, shift_key, canvasX, canvasY, screenX, screenY)
    {
                
        // 링크 영역 구한후 기능 열어야함.
        var v = this._getUrl();
        if (v)  nexacro._execBrowser(v);
    };

    _pStatic.on_touchend_basic_action = function (touch_manager, changedtouchinfos)
    {        
        nexacro.Component.prototype.on_touchend_basic_action.call(this, touch_manager, changedtouchinfos);
