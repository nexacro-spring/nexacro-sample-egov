...
//==============================================================================
// nexacro.TextArea && nexacro.TextArea_Style
//==============================================================================

if (!nexacro.TextArea)
{
    //==============================================================================
    // nexacro.TextArea_Style
    //==============================================================================
    ...
    _pTextAreaStyle.__get_custom_style_value = function ()
    {
        ...
        if (this.linespace && this.linespace._is_empty) val += "linespace:" + this.linespace._value + "; ";
        if (this.caretcolor && !this.caretcolor._is_empty) val += "caretcolor:" + this.caretcolor._value + "; ";
        if (this.compositecolor && !this.compositecolor._is_empty) val += "compositecolor:" + this.compositecolor._value + "; ";
        if (this.selectcolor && !this.selectcolor._is_empty) val += "selectcolor:" + this.selectcolor._value + "; ";
        if (this.selectbackground && !this.selectbackground._is_empty) val += "selectbackground:" + this.selectbackground._value + "; ";
    ...
    nexacro.TextArea = function (id, position, left, top, width, height, right, bottom, parent)
    {
        ...
        this._event_list = {
            ...
            "canchange": 1, "onchanged": 1, "oneditclick": 1, "ontextchange": 1, "ontextchanged": 1, "cancharchange": 1, "onchar": 1,
            "onvscroll": 1, "onhscroll": 1, "onmousewheel": 1,
            "oncontextmenu": 1,
    ...
    //nexacro.TextArea._default_cursor = nexacro._getCachedStyleObj("cursor", "text");

    //===============================================================
    // nexacro.TextArea : Style Part
    //===============================================================
    ...
    _pTextArea.on_change_bindSource = function (propid, ds, row, col, index)
    {
        if (propid == "value")
        {
            ...
            if (api && input_elem)
            {
                if (nexacro._checkActiveElement(input_elem))
                {
    ...
    _pTextArea.set_value = function (v)
    {
        ...
        if (v && v !== undefined && v != "")
        {
            ...
            {
                if (v.indexOf("\r") != -1) v = v.replace(/\r/g, "");
            }
        }
    ...
    _pTextArea._on_killfocus = function (obj, e)
    {
        ...
        if (api && elem)
        {
            ...
            if (nexacro.Browser == "IE" && !elem._is_focused)
            {
        ...
        var api = this._edit_base_api;
            ...
            if (nexacro.Browser == "IE")
            {
                ...
                if (this.visible)
                {
                    ...
                    if (nexacro.BrowserVersion <= 8)    // 9이상은 async 동작으로 인해 element에서 초기화
                    {
    	...
    	if (nexacro.Browser == "IE" && nexacro.BrowserVersion <= 8)
    	{
    		if (nexacro._enableaccessibility)
    		{
    			if (keycode == nexacro.Event.KEY_DOWN || keycode == nexacro.Event.KEY_UP)
    			{
    				...
    				if (!line_text) line_text = "#textarea:msg_accessibility_emptyline";
    ...
    _pTextArea._getHLineInfo = function (idx, scroll_pos)
    {
        ...
        {
            r = nexacro._getTextSize2(value.charAt(i++), curstyle.font, ((this.wordwrap != "none" && this.wordwrap != false && this.wordwrap != "false") ? true : false));
            s_begin_width += r[0];
        }
        ...
        {
            r = nexacro._getTextSize2(value.charAt(i++), curstylee.font, ((this.wordwrap != "none" && this.wordwrap != false && this.wordwrap != "false") ? true : false));
            s_end_width += r[0];
        }
    ...
    _pTextArea._getVLineInfo = function (pos)
    {
        ...
        var font_size = nexacro._getTextSize2("Wj", font);
        ...
        return { begin: begin_line, end: end_line };
    };
    ...
    _pTextArea._getMaxTextLine = function ()
    {
        ...
        {
            var linespace = curstyle.linespace ? nexacro._toInt(curstyle.linespace) : 0;
            var lineheight = nexacro._getTextSize2("Wj", curstyle.font, ((this.wordwrap != "none" && this.wordwrap != false && this.wordwrap != "false") ? true : false))[1] + linespace;
    ...
    {
        //if (this._max_line != null)   성능개선 필요시 open후 테스트 필요
          //  return this._max_line;
    ...
    {
    	// 이동 전 caret pos를 통해서 이동 후의 line string을 얻어올 수 있다.
    	...
    	else if (direction == 0)		// focus
    	{
    		// find first line string
    		var text = this.value;
    		if (text)
    		{
    			var textarr = text.split("\n");
    ...
    _pTextArea._setVScrollDefaultAction = function (vscrollbar, wheelDelta)
    {
        ...
        var lineheight = nexacro._getTextSize2("Wj", currentstyle.font, ((this.wordwrap != "none" && this.wordwrap != false && this.wordwrap != "false") ? true : false))[1] + linespace;
        if (wheelDelta >= 0)
        {
            var wheelline = 3;
        }
    ...
    //===============================================================
    // nexacro.TextAreaCtrl : TextArea1839
