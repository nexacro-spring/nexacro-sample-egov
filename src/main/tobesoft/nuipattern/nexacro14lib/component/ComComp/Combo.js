...
if (!nexacro.Combo)
{
	...
	nexacro.Combo = function (id, position, left, top, width, height, right, bottom, parent)
	{
		...
		this._selectinfo = { index: -1, text: "", value: undefined };

		this._eventinfo = { postindex: -1, posttext: "", postvalue: undefined, preindex: -1, pretext: "", prevalue: undefined, isselect: false };
		...
		this._event_list = {
			...
			"onlbuttondown": 1, "onlbuttonup": 1, "onmouseenter": 1, "onmouseleave": 1, "onmousemove": 1, "onrbuttondown": 1, "onrbuttonup": 1,
			...
			"oneditclick": 1, "ontextchanged": 1, "onitemclick": 1, "canitemchange": 1, "onitemchanged": 1,
			"ondropdown": 1, "oncloseup": 1, "ontextchange": 1, "onchar": 1, "cancharchange": 1,
			"oncontextmenu": 1, "onmousewheel": 1
		};
	    ...
	    if (this._isPopupVisible())
	    {
	        ...
	        if (!nexacro._isDesktop() && nexacro.OS == "Android" && nexacro.Browser == "Runtime")
	        {
	            ...
	            _observer._interval_timer = new nexacro.CallbackTimer(this, function ()
	            {
                    ...
                    {
                        // "(Combo)ElemPos SyncError Detected!!!!"
	...
	_pCombo.on_apply_text = function ()
	{
		...
		if (!ds || (!this.datacolumn && !this.codecolumn) || !this._is_created)
		{
	...
	_pCombo.on_fire_onkillfocus = function (obj, fromObj)
	{
		...
		if (this.comboedit)
		{
		    //this.comboedit._on_killfocus(obj, fromObj);
    ...
    _pCombo.on_fire_sys_onlbuttonup = function (button, alt_key, ctrl_key, shift_key, screenX, screenY, canvasX, canvasY, clientX, clientY, from_comp, from_refer_comp, from_elem)
	{
		...
		if (from_refer_comp instanceof nexacro.ScrollBarCtrl) return;
        if (from_refer_comp && from_refer_comp.parent instanceof nexacro.ScrollBarCtrl) return;
	...
	_pCombo.on_fire_oncloseup = function (obj, beforeIndex, beforeText, beforeValue, afterIndex, afterText, afterValue, isSelect)
	{
		...
		if (this.combolist)
		{
		    ...
		    if (!this._enterkey) this.combolist._reset_item(listidx);
			this._enterkey = false;
			this.combolist._overeditemindex = -1;
			this._moverindex = -1;
			if (this.combolist._overedItem) this.combolist._overedItem = null;
		}
	...
	// ==============================================================================
	// nexacro.Combo : Logical Part ( Internal Function Part )
	// ==============================================================================
	...
	_pCombo._recalcLayout = function ()
	{
		...
		if (dropbutton)
		{
			...
			var btn_margin = dropbutton.on_find_CurrentStyle_margin("normal");
		...
		if (comboedit)
		{
			...
			var edit_margin = comboedit.on_find_CurrentStyle_margin("normal");
	...
	_pCombo._update_popupwindow_position = function ()
	{
	    ...
	    if (popupwindow)
	    {
	        ...
	        // popup을 combo가 포함된 위치의 최종 누적 zoom비율이 반영된 위치로 이동
	        {
	            var offs = { x: 0, y: 0 };
	...
	_pCombo._showPopup = function (ds, index)
	{
        ...
        if (combolist)
        {
            if (this._getPopupType() == "center")
            {
                //this._centerPopup(popupwindow, width, height);
	...
	// ==============================================================================
	// nexacro.ComboListCtrl ( Combo SubCtrol 1 )
	// ==============================================================================
	...
	//---------------------------------------------------------------
	// nexacro.ComboListCtrl : Event Handlers
	//--------------------------------------------------------------- 
	...
	//---------------------------------------------------------------
	// nexacro.ComboListCtrl : Logical Part
	//--------------------------------------------------------------- 
	...
	_pComboListCtrl._changeIndex = function (v, bIgnoreCompareIdx, change_by_script, funcname)
	{
	    ...
	    if (bIgnoreCompareIdx || v != this.index ||
           (parent.type == "search" && parent.index != v && v == this.index && !parent._keyval))
	    {
	...
	// ==============================================================================
	// nexacro.ComboListItemCtrl ( Combo SubCtrol 2 )
	// ==============================================================================
	...
	//---------------------------------------------------------------
	// nexacro.ComboListItemCtrl : Event Handlers
	//---------------------------------------------------------------
	...
	// ==============================================================================
	// nexacro.ComboEditCtrl ( Combo SubCtrol 3 )
	// ==============================================================================
	...
	//---------------------------------------------------------------
	// nexacro.ComboEditCtrl : Override
	//---------------------------------------------------------------
	...
	//---------------------------------------------------------------
	// nexacro.ComboEditCtrl : Properties
	//---------------------------------------------------------------
	...
	//---------------------------------------------------------------
	// nexacro.ComboEditCtrl : Event Handlers
	//---------------------------------------------------------------
	...
	// ==============================================================================
	// nexacro.ComboButtonCtrl ( Combo SubCtrol 4 )
	// ==============================================================================
	...
	//---------------------------------------------------------------
	// nexacro.ComboButtonCtrl : Override 
	//---------------------------------------------------------------
	...
	//---------------------------------------------------------------
	// nexacro.ComboButtonCtrl : Event Handlers
	//---------------------------------------------------------------
	...
	// ==============================================================================
	// nexacro.ComboPopupWindow ( Combo SubCtrol 5 )
	// ==============================================================================
	...
	//---------------------------------------------------------------
	// nexacro.ComboPopupWindow : Properties
	//---------------------------------------------------------------
	...
	//---------------------------------------------------------------
    // nexacro.ComboPopupWindow : Override
    //---------------------------------------------------------------
	...
	//---------------------------------------------------------------
	// nexacro.ComboPopupWindow : Logical Part
	//---------------------------------------------------------------
