...
if (!nexacro.ScrollBar)
{
    ...
    {
        var val = "";
        if (this.barminsize && !this.barminsize._isEmpty) val += "barminsize:" + this.barminsize._value + "; ";
        if (this.baroutsize && !this.baroutsize._isEmpty) val += "baroutsize:" + this.baroutsize._value + "; ";
        if (this.incbtnsize && !this.incbtnsize._isEmpty) val += "incbtnsize:" + this.incbtnsize._value + "; ";
        if (this.decbtnsize && !this.decbtnsize._isEmpty) val += "decbtnsize:" + this.decbtnsize._value + "; ";
        if (this.imgoutsize && !this.imgoutsize._isEmpty) val += "imgoutsize:" + this.imgoutsize._value + "; ";
        if (this.scrollbarsize && !this.scrollbarsize._isEmpty) val += "scrollbarsize:" + this.scrollbarsize._value + "; ";
        if (this.trackbarsize && !this.trackbarsize._isEmpty) val += "trackbarsize:" + this.trackbarsize._value + "; ";
        return val;
    };
    ...
    nexacro.ScrollBar = function (id, position, left, top, width, height, right, bottom, parent)
    {
        ...
        this.trackbarsize = -1;
        this.direction = "vert";
        this.line = 1; //readonly
        this.page = 3; //readonly
        this.view = -1; //???
        this.max = 0; // default : 0
        this.min = 0;
        this.pos = 0;
        this.onscroll = null;
        ...
        this._event_list = {
            ...
            "onmove": 1, "onsize": 1, "ongesture": 1, "onscroll": 1
        };
        
        /* internal variable */
        this._rectShaft = new nexacro.Rect();
        this._mousePoint = {};
        this._max = 0; // default : 0
        this._min = 0;
        this._orgmax = 0;
        ...
        this._start_page_navi = null; //page repeat시에 up, down, left, right 로 시작하는 것을 구분
    ...
    //===============================================================
    // nexacro.ScrollBar : Create & Destroy & Update
    //===============================================================
    ...
    //===============================================================
    // nexacro.ScrollBar : Override
    //===============================================================

    //===============================================================
    // nexacro.ScrollBar : Properties
    //===============================================================
    ...
    //===============================================================
    // nexacro.ScrollBar : Methods
    //===============================================================

    //===============================================================
    // nexacro.ScrollBar : Event Handlers
    //===============================================================
        ...
        if (control_elem && this._is_created_contents)
        {
            ...
            if (this.direction == "vert")
            {
                ...
                if (nShaftSize > 0)
                {
                    ...
                    //var nSize = this.max - this.min;
                    var nSize = this._max - this._min;

                    if (nBarOut < 0) nBarOut = r - l;
                    if (nBarMin < 0)
                    {
                        nBarMin = ((r - l) * 0.60) | 0;
                        if (nBarMin < nexacro.ScrollBar.TRACKBAR_SIZE_MIN) nBarMin = nexacro.ScrollBar.TRACKBAR_SIZE_MIN;
                    }
                    if (nView < 0) nView = 1;
    ...
    _pScrollBar._movetrack = function (x, y)
    {
        ...
        else
        {
            ...
            if ((nDiff < 0 && rcTrackOrigin.left > rc.left) || (nDiff > 0 && rcTrackOrigin.right < rc.right))
            {
                ...
                nNew = parseInt(nSize * ((rcTrack.left - rc.left) /
    ...
    // ==============================================================================
    // ScrollBarCtrl : ScrollBar used as Control ==> use Event Notifiers, style control - controlType
    // ==============================================================================
