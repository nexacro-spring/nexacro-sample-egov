...
if (!nexacro.Chart_Style) 
{
    ...
    {
        var val = "";
        if (this.baritemminsize && !this.baritemminsize._is_empty)         val += "baritemminsize:" + this.baritemminsize._value + "; ";
        if (this.baritemspacing && !this.baritemspacing._is_empty)         val += "baritemspacing:" + this.baritemspacing._value + "; ";
        if (this.barspacing && !this.barspacing._is_empty)                 val += "barspacing:" + this.barspacing._value + "; ";
        if (this.lineextendorigin && !this.lineextendorigin._is_empty)     val += "lineextendorigin:" + this.lineextendorigin._value + "; ";
        if (this.scrollbarsize && !this.scrollbarsize._is_empty)           val += "scrollbarsize:" + this.scrollbarsize._value + "; ";
        if (this.seriesextendaxis && !this.seriesextendaxis._is_empty)     val += "seriesextendaxis:" + this.scrollbarsize._value + "; ";
        return val;
    };
