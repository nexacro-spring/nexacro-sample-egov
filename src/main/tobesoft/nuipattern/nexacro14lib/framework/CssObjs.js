...
if (!nexacro._bInitCssObjects) 
{
	...
	{
		if (!v || v.isEmpty() || v._value == chkval) return def;
		return v.value;
	};
	...
	//==============================================================================
	// Value attribute Append Function nexacro._createValueAttributeEvalStr("_pPrototype", "attr_name");
	...
	//==============================================================================
	// Color attribute Append Function nexacro._addAlignAttribute(nexacro.Style.prototype, "value");
	...
	//==============================================================================
	// Align attribute Append Function nexacro._addAlignAttribute(nexacro.Style.prototype, "align");
		...
		case 0:
			{
				...
				if (this.repeat) val += ' ' + this.repeat;
				if (this.imageedge) val += ' ' + this.imageedge;
				if (this.position) val += ' ' + this.position;
	...
	_pStyleBackground.__load_imageedge = function (str) 
	{
		if (str.indexOf(",") >= 0)
		{
			...
			if (this.imageedge_x < 0) this.imageedge_x = 0;
			if (this.imageedge_y < 0) this.imageedge_y = 0;
			this.imageedge = this.imageedge_x + "," + this.imageedge_y;
			return true;
		}

        // not use single value !! 
			...
			for (var i = 0; i < cnt; i++) 
			{
				...
				if (part) 
				{
					...
					else if (bLoadImage && part.length >= 5 && part.substring(0, 3).toLowerCase() == "url") 
					{
						...
						if (ch == '\'' || ch == '\"') image_uri = part.substring(5, part.length - 2);
						else image_uri = part.substring(4, part.length - 1);
	...
	_pStyleBackground.set_image = function (v) 
	{
		...
		{
			var ch = str.charAt(4);
			if (ch == '\'' || ch == '\"') str = str.substring(5, v.length - 2);
			else str = str.substring(4, str.length - 1);
		}
	...
	//==============================================================================
	// Background attribute Append Function nexacro._addBackgroundAttribute(nexacro.Style.prototype, "background");
	...
	//==============================================================================
	// Border attribute Append Function nexacro._addLineAttribute(nexacro.Style.prototype, "linetype");
	...
	//==============================================================================
	// nexacro.Style_border, nexacro.Style_border
	nexacro.Style_border = function (tw, ts, tc, tc2, rw, rs, rc, rc2, bw, bs, bc, bc2, lw, ls, lc, lc2) 
	{
        ...
        this.style = "";
/*
        this._default_width = 1;
        this._default_color = "#6d6d6dff";
        this._default_color2 = "#6d6d6dff";
        this._default_style = "solid";
        */
		//------------------ internal variable ---------------------//
		this._is_empty = true;
		this._value = "";
	...
	_pStyleBorder._parseInfo = function(val) 
	{
		...
		else 
		{
			...
			if (this._linecnt > 4) this._linecnt = 4;
			switch (this._linecnt) 
			{
			    case 4:
			        this.left = linearr[3];
	...
	_pStyleBorder.set_width = function (v) 
	{
		if (!this.width || v !== this.width) 
		{
			...
			this._width = _v;
/*
			if (!this.style) this.style = this._default_style;
			if (!this.color) this.color = this._default_color;
            */
			return this._updateValue();
		}
		return false;
	...
	//==============================================================================
	// Border attribute Append Function nexacro._addBorderAttribute(nexacro.Style.prototype, "border");
	        ...
	        case 0:
	            {
	                ...
	                return { value: val, sysvalue: sysval };
	            }
	        case 1:
	            var val = "bind:" + this._bindexpr;
	            return { value: val, sysvalue: val };
	        case 2:
	...
	//==============================================================================
	// Bordertype attribute Append Function nexacro._addBordertypeAttribute(nexacro.Style.prototype, "bordertype", 0);
	...
	//==============================================================================
	// nexacro.Style_pointColor, nexacro.Style_pointColor
	// not bindable
	...
	_pStylePointColor.update = function (_apply_) 
	{
		...
		{
			if (this._target) this._target.on_update_style_pointcolor();
		}
	};
	...
	//==============================================================================
	// Gradation attribute Append Function nexacro._addGradationAttribute(nexacro.Style.prototype, "gradation");
	...
	//==============================================================================
	// Create Padding attribute eval string
	...
	//==============================================================================
	// Create Margin attribute eval string
	...
	//==============================================================================
	// nexacro.Style_shadow : Style_shadow - readonly, Style_shadow - Writable
	...
	//==============================================================================
	// Create Shadow attribute eval string 
	...
	//==============================================================================
	// Create Blur attribute eval string
	...
	//==============================================================================
	// nexacro.Style_glow : Style_glow - readonly, Style_glow - Writable
	...
	//==============================================================================
	// create Glow attribute eval string
	...
	_pStyleAccessibility._getValueStr = function() 
	{
	    switch (this._bindtype)
	    {
	        case 0:
	            {
	                var str = "";
	                if (this.role) str += this.role + " ";
	                if (this.enable) str += "enable ";
	                else str += "disable ";
	...
	_pStyleAccessibility._parseInfo = function (val)
	{
	    ...
	    else
	    {
	        ...
	        if (valarr.length >= 3)
	        {
	            ...
	            if (valarr[j++] == "disable") this.enable = false;
	            ...
	            else if (valarr.length == 4 && !isRole) this.description = valarr[j];
	            ...
	            else if (valarr.length == 5 && !isRole) this.action = valarr[j];
	            else this.action = "";
	        }
	    }
	};
	...
	//==============================================================================
	// create Accessibility attribute eval string
    ...
    //==============================================================================
    // nexacro.Style_fillbrush : Style_fillbrush
	...
	_pStyleFillbrush._getValueStr = function() 
	{
	    switch (this._bindtype)
	    {
	        case 0:
	            {
	                var val = "";
	                if (this.style) val += this.style + " ";
	                if (this.color) val += this.color;
	                return val;
	            }
	        case 1:
	            return "bind:" + this._bindexpr;
	...
	//==============================================================================
	// Fillbrush attribute eval string
	...
	//==============================================================================
	// nexacro.Style_strokepen : Style_strokepen
	...
	{	    	
		...
		if (s != null) 
		{
			this.width = w;
			this.style = s;
			if(color == "transparent") this.color = "";
	...
	//==============================================================================
	// Strokepen attribute eval string
		...
		else 
		{
			...
			switch ( valarr[0] ) 
			{
			    ...
			    case "heavydense":
					...
					break;
				default :
				    this.style = ""; // none 값 추가, "" 이면 css find continuously
					break;						
			}
			this.color = valarr[1];
		}
	...
	_pStyle._getValueStr = function() 
	{
		...
		if (!this._is_empty) 
		{
			if (this.bordertype && !this.bordertype._is_empty) val += "bordertype:" + this.bordertype._value + "; ";
			if (this.border && !this.border._is_empty) val += "border:" + this.border._value + "; ";
			if (this.background && !this.background._is_empty) val += "background:" + this.background._value + "; ";
			if (this.gradation && !this.gradation._is_empty) val += "gradation:" + this.gradation._value + "; ";
			if (this.margin && !this.margin._is_empty) val += "margin:" + this.margin._value + "; ";
			if (this.padding && !this.padding._is_empty) val += "padding:" + this.padding._value + "; ";
			if (this.cursor && !this.cursor._is_empty) val += "cursor:" + this.cursor._value + "; ";
			if (this.opacity && !this.opacity._is_empty) val += "opacity:" + this.opacity._value + "; ";
			if (this.shadow && !this.shadow._is_empty) val += "shadow:" + this.shadow._value + "; ";
			if (this.align && !this.align._is_empty) val += "align:" + this.align._value + "; ";
			if (this.font && !this.font._is_empty) val += "font:" + this.font._value + "; ";
			if (this.color && !this.color._is_empty) val += "color:" + this.color._value + "; ";
			if (this.accessibility && !this.accessibility._is_empty) val += "accessibility:" + this.accessibility._value + "; ";
			if (this.rtlimagemirroring && !this.rtlimagemirroring._is_empty) val += "rtlimagemirroring:" + this.rtlimagemirroring._value + "; ";
	...
	//_pCurrentStyle._type_name = "CurrentStyle";
    ...
    {
    	// private method (to copy array of objects) - getCloneOfObject will use
        var tempClone = [];
